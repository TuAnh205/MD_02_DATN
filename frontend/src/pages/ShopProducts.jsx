...
export default function ShopProducts() {
  ...
  useEffect(() => {
    ...
    // Listen for order status changes and refresh billing summary
      ...
      {billingSummary?.isFrozen && (
        <div className="rounded-xl border border-rose-200 bg-rose-50 px-5 py-4">
          <p className="text-sm font-semibold text-rose-900">
            Tài khoản shop đang bị đóng băng bán hàng
          </p>
          <p className="mt-1 text-sm text-rose-800">{billingSummary.message}</p>
          <p className="mt-2 text-xs text-rose-700">
            Số dư ví hiện tại: {formatCurrency(billingSummary.walletBalance)}.
            Công nợ: {formatCurrency(billingSummary.outstandingAmount)}.
          </p>
        </div>
      )}
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-blue-700">
              Tất cả đơn hàng thanh toán thành công từ{" "}
              {formatDateTime(policy?.feeStartDate)} trở đi sẽ bị tính phí sàn{" "}
              <strong>
                {Math.round((policy?.commissionRate || 0.05) * 100)}%
              </strong>{" "}
              trên giá sản phẩm.
            </p>
            <p className="mt-1 text-xs text-blue-600">
              Phí chỉ áp dụng khi khách hàng thanh toán thành công. Hệ thống tự
              động trừ phí từ ví shop.
            </p>
          </div>
        </div>
      </div>
                  ...
                  <div className="mt-4 border rounded-md p-4 bg-gray-50">
                    ...
                    <img
                      ...
                      onError={() => {
                        ...
                        alert(
                          "Lỗi tải ảnh. Vui lòng kiểm tra đường dẫn hoặc thử file khác.",
                        );
                      }}
                    />
                  </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="inline-flex items-center justify-center h-8 w-8 rounded-md text-gray-600 hover:bg-blue-100 hover:text-blue-600 transition-colors"
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center h-8 w-8 rounded-md text-gray-600 hover:bg-red-100 hover:text-red-600 transition-colors"
                    title="Xóa sản phẩm"
                  >
                    🗑️
                  </button>
